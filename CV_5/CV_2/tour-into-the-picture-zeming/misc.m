...
pad_left=ceil(1-bound(1,1));
pad_down=ceil(bound(2,2)-m);
pad_right=ceil(bound(1,2)-n);
pad_up=ceil(1-bound(2,1));
...
min_y=min_y+pad_up;max_y=max_y+pad_up;
min_x=min_x+pad_left;max_x=max_x+pad_left;
